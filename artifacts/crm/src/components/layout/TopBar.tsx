...
import { useLogout, useListNotifications, useMarkNotificationRead, useMarkAllNotificationsRead, getListNotificationsQueryKey } from "@workspace/api-client-react";
  ...
  return (
    <header className="h-16 shrink-0 border-b bg-card flex items-center justify-between px-6 z-10 sticky top-0 md:static ml-12 md:ml-0">
      <div className="flex items-center gap-4">
        <h1 className="text-xl font-semibold hidden sm:block">Real Estate OS</h1>
      </div>
