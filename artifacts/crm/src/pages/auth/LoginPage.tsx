...
function usePalette() {
  ...
  return {
    ...
    fg:            dark ? "#DDE8F4"                      : "#0D1E35",
    fgBody:        dark ? "#7AAAC8"                      : "#2C5070",
    fgMuted:       dark ? "#4E7A9A"                      : "#4A7A9B",
    inputBorder:   dark ? "rgba(255,255,255,0.12)"       : "rgba(15,31,56,0.18)",
    inputFocused:  "#c8a84b",
    inputText:     dark ? "#C8D8E8"                      : "#0D1E35",
    gridOpacity:   dark ? 0.035                          : 0.055,
    statDivider:   dark ? "rgba(200,168,75,0.14)"        : "rgba(200,168,75,0.25)",
    oauthBorder:   dark ? "rgba(255,255,255,0.1)"        : "rgba(15,31,56,0.14)",
    oauthText:     dark ? "#6B95B8"                      : "#2C5070",
    divider:       dark ? "rgba(200,168,75,0.2)"         : "rgba(200,168,75,0.3)",
    brandText:     dark ? "#8BAFC7"                      : "#2C5070",
    premiumText:   dark ? "#4E7A9A"                      : "#4A7A9B",
    registerText:  dark ? "#4E7A9A"                      : "#2C5070",
