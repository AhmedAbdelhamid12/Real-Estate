...
import type { NativeTheme } from "@workspace/design-tokens/native";
...
export default function HomeScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Today's Tasks */}
      <View style={[s.section, { marginBottom: insets.bottom + 34 + 60 }]}>
          ...
          todayTasks.slice(0, 5).map((task) => {
            ...
            return (
              <View key={task.id} style={s.taskRow}>
                ...
                {done && <View style={[s.badge, { backgroundColor: `${c.success}18` }]}>
...
function makeStyles(c: ReturnType<typeof useColors>["colors"], bottomInset: number) {
  return StyleSheet.create({
    ...
    orgText:       { fontSize: 12, fontWeight: "700" as const, color: c.accent },
